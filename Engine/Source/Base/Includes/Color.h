...
namespace Base
{
  ...
  public:
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /// Returns the color as a 32 bit integer - ARGB
    ///
    /// @return the color as a 32 bit integer - ARGB
    ///
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
    BASE_API uint32 GetAsARGB() const;
  ...
  public:
    uint8 m_Red;    ///< Red component of the color.
    uint8 m_Green;  ///< Green component of the color.
    uint8 m_Blue;   ///< Blue component of the color.
    uint8 m_Alpha;  ///< Alpha component of the color.
  };
}  // namespace Base
#endif  // Color_h__

...
namespace Base
{
  ...
  public:
    ...
    BASE_API static cVector3 RotateAboutX(const cVector3& vec, float angleInRad);
    BASE_API static cVector3 RotateAboutY(const cVector3& vec, float angleInRad);
    BASE_API static cVector3 RotateAboutZ(const cVector3& vec, float angleInRad);

//  *******************************************************************************************************************
//  Resources   version:  1.0   Ankur Sheel  date: 2012/12/29
//  *******************************************************************************************************************
//
//  *******************************************************************************************************************
...
namespace Utilities
{
  ...
  class cResHandle : public IResHandle
  {
  public:
    UTILITIES_API cResHandle(cResource& resource, char* pBuffer, unsigned int iSize, IResCache* pResCache);

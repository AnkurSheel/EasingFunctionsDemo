...
namespace Utilities
{
  ...
  public:
    ...
    /********************************************/ /**
      ...
      ***********************************************/
    virtual void VInitializeForSave(const Base::cString& strRootName, const Base::cString& strStyleSheetPath) = 0;
    /********************************************/ /**
    ...
    /********************************************/ /**
      ...
      ***********************************************/
    virtual void VAddComment(const Base::cString& strParentElementID, const Base::cString& strComment) = 0;
    /********************************************/ /**
      ...
      ***********************************************/
    virtual Base::cString VAddElement(const Base::cString& strParentName, const Base::cString& strElementName,
                                      const Base::cString& strElementAttribID,
    ...
    /********************************************/ /**
      ...
      ***********************************************/
    virtual void VAddAttribute(const Base::cString& strElementName, const Base::cString& strAttributeName,
    ...
    /********************************************/ /**
      ...
      * int and returns it
      ***********************************************/
    virtual int VGetNodeAttributeAsInt(const Base::cString& strElementID, const Base::cString& strAttributeName) = 0;
    /********************************************/ /**
      * @param[in] strElementID The unique ID of the element
      * @param[in] strAttributeName The attribute name
      ...
      * bool and returns it
      ***********************************************/
    virtual bool VGetNodeAttributeAsBool(const Base::cString& strElementID, const Base::cString& strAttributeName) = 0;
    /********************************************/ /**
      ...
      ***********************************************/
    virtual void VGetAllChildrenNames(const Base::cString& strParentID, std::vector<Base::cString>& vElements) = 0;
    /********************************************/ /**

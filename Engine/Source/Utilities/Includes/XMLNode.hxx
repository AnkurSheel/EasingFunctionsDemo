...
namespace Utilities
{
  ...
  public:
    ...
    virtual Base::cVector3 VGetChildValueAsVector3(const Base::cString& Name,
                                                   const Base::cVector3& DefaultValue) const = 0;
    virtual Base::cVector2 VGetChildValueAsVector2(const Base::cString& Name,
                                                   const Base::cVector2& DefaultValue) const = 0;

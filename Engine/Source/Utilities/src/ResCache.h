...
namespace Utilities
{
  ...
  class cResCache : public IResCache
  {
  public:
  ...
  {
  public:
    explicit cResourceZipFile(const Base::cString& resFileName);
  ...
  {
  public:
    explicit cDevelopmentResourceZipFile(const Base::cString& resFileName);

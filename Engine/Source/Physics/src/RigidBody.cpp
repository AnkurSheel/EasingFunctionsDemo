...
//  *******************************************************************************************************************
void cRigidBody::VApplyImpulse(const cVector3 & force)
{
	m_LinearVelocity += (m_InverseMass * force);
}
...
void cRigidBody::ApplyGravity(const float timeStep)
{
	...
	VApplyImpulse(cVector3(0, gravity * timeStep / 2.0f, 0));
}
...
//  *******************************************************************************************************************
void cRigidBody::VStop()
{
	m_Force = cVector3::Zero;
	m_LinearVelocity = cVector3::Zero;
}
...
//  *******************************************************************************************************************
void cRigidBody::VSetActive(bool active)
{
	m_Active = active;
	if (!active)
	{

...
//  *******************************************************************************************************************
ISoundResHandle::ISoundResHandle(Utilities::cResource& resource, unsigned char* pBuffer, unsigned int uiSize,
                                 IResCache* pResCache)
...
//  *******************************************************************************************************************
cSoundResHandle::cSoundResHandle(Utilities::cResource& resource, unsigned char* pBuffer, unsigned int uiSize,
                                 IResCache* pResCache)
...
bool cSoundResHandle::VInitialize()
{
  if (!m_Initialized)
  {
    ...
    {
      SP_ASSERT_ERROR(false)("We do not support " + extension + " at this time");
    }
    m_Initialized = true;
  }
  return true;
    ...
    switch (uiType)
    {
      case mmioFOURCC('f', 'a', 'c', 't'):
        SP_ASSERT_ERROR(false)
            .SetCustomMessage("This wav file is compressed. We don't handle compressed wav at this time");
        break;

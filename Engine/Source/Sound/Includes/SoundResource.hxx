...
namespace Sound
{
  /********************************************/ /**
    ...
    ***********************************************/
  class cSoundResource : public Utilities::cResource
  {
  public:
    SOUND_API cSoundResource(const Base::cString& strName);
    ~cSoundResource();
    Utilities::IResHandle* VCreateHandle(const char* pBuffer, unsigned int uiSize, Utilities::IResCache* pResCache);
  };

  class ISoundResHandle : public Utilities::cResHandle
  {
  public:
    ISoundResHandle(Utilities::cResource& resource, unsigned char* pBuffer, unsigned int uiSize,

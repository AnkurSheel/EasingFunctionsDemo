...
namespace Graphics
{
  ...
  struct stModelDef
  {
    ...
    UINT64* pIndices;                      ///< The index data of this model
  ...
  public:
    ...
    ////////////////////////////////////////////////////////////////////////
    virtual void VRecalculateWorldMatrix(const Base::cVector3 vPosition, const Base::cVector3 vRotation,
                                         const Base::cVector3 vScale) = 0;
    ////////////////////////////////////////////////////////////////////////

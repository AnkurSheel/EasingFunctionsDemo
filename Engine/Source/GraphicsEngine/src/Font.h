...
namespace Graphics
{
  ...
  ///
  ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  class cMyFont : public IMyFont, Base::cNonCopyable
  {
  public:
    cMyFont();
  ...
  private:
    ...
    void VRender(const XMFLOAT4X4& inMatWorld, const XMFLOAT4X4& inMatView, const XMFLOAT4X4& inMatProjection,
  ...
  private:
    ...
    CharDescriptorMap
        m_CharDescriptorMap;  /// The map contaning all the character descriptions with their ascii value as the key

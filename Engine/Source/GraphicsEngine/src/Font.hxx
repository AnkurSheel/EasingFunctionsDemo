...
namespace Graphics
{
  ...
  public:
    ...
    struct CharDescriptor
    {
      ...
      unsigned short XOffset;   /// How much the current position should be offset when copying the image from the font
                                /// texture to the screen */
      unsigned short YOffset;   /// How much the current position should be offset when copying the image from the font
                                /// texture to the screen */
  ...
  public:
    ...
    /********************************************/ /**
      ...
      ***********************************************/
    virtual void VRender(const XMFLOAT4X4& inMatWorld, const XMFLOAT4X4& inMatView, const XMFLOAT4X4& inMatProjection,
                         const Base::cColor& textColor) = 0;
    /********************************************/ /**

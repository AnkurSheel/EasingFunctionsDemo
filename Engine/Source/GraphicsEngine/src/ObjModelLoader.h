...
//
//  *******************************************************************************************************************
#ifndef OBJMODELLOADER_H__
#define OBJMODELLOADER_H__
...
namespace Graphics
{
  class cObjModelLoader : public IObjModelLoader
  {
  private:
    ///< Map of Model definitions. The key is the hash of the model filename. Value is a shared_ptr to the actual model
    /// def.
    typedef std::map<UINT64, shared_ptr<stModelDef> > ModelDefMap;
  ...
  private:
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /// Parses the string value and returns it as a float. If the value is invalid returns 0.
    ///
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /// Parses the string value and returns it as a int. If the value is invalid returns 0.
    ///
    /// @param[in] strVal The value as a string
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /// Checks if the model def has already been loaded. Returns a pointer to the model def if it is found. NULL
    /// otherwise.
    ///
    ...
    /// NULL otherwise
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
    shared_ptr<stModelDef> Find(const UINT64 ulModelDefHash);
    void Cleanup();

...
namespace Graphics
{
  ...
  protected:
    ...
    UIEventCallBackFn
        m_callbackIncrementArrowPressed;  /// Callback function when the up/left button is pressed/released.
    UIEventCallBackFn
        m_callbackDecrementArrowPressed;        /// Callback function when the bottom/right button is pressed/released.

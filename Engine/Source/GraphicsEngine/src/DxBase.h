...
namespace Graphics
{
  ...
  ///
  ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  class cDXBase : public IDXBase, public Base::cNonCopyable
  {
  private:
    cDXBase();
    ~cDXBase();
    bool VInitialize(const stInitializationParameters& params);
    void VBeginRender();
    void VEndRender();
    void VTurnZBufferOn();
    ...
    void VSetFullScreenMode(const bool bIsFullScreen, const int iNewWidth, const int iNewHeight);
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ///< Sets up the device, swap chain, depth buffer, depth stencil state. Bind the render target view and the
    ///< depth stencil buffer to the output render pipeline.
    ///
  ...
  private:
    ...
    ID3D11DepthStencilState* m_p3DDepthStencilState;  ///< The depth stencil state allows us to control what type of
    ...
    XMFLOAT4X4
        m_matWorld;  ///< The world matrix is used to convert the vertices of our objects into vertices in the 3D scene.
    XMFLOAT4X4 m_matOrtho;  ///< The orthographic projection matrix is used for rendering 2D elements on the screen
    ...
    bool m_bVsyncEnabled;  ///< True if we want Direct3D to render according to the users monitor refresh rate. False if

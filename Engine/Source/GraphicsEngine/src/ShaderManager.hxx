...
namespace Graphics
{
  ...
  public:
    ...
    /********************************************/ /**
      ...
      * @param[in] strShaderName The name of the shader. This should be the same as the vertex and pixel shader files
      ...
      ***********************************************/
    virtual bool VGetShader(shared_ptr<IShader>& pShader, const Base::cString& strShaderName) = 0;

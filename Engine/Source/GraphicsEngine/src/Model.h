...
namespace Graphics
{
  ...
  ///
  ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  class cModel : public IModel, public Base::cNonCopyable
  {
  public:
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  private:
    ...
    void VRecalculateWorldMatrix(const Base::cVector3 vPosition, const Base::cVector3 vRotation,
                                 const Base::cVector3 vScale);
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
    bool CreateIndexBuffer(const UINT64* const pIndices);
  ...
  private:
    ...
    shared_ptr<cTextureShader>
        m_pShader;  ///< The shader responsible for rendering the model depending on the model vertex data type.
